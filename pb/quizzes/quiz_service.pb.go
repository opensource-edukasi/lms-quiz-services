...
var file_quizzes_quiz_service_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x9e, 0x01, 0x0a, 0x07, 0x51,
	...
	0x7a, 0x7a, 0x65, 0x73, 0x2e, 0x51, 0x75, 0x69, 0x7a, 0x22, 0x00, 0x42, 0x14, 0x5a, 0x12, 0x70,
...
var file_quizzes_quiz_service_proto_goTypes = []any{
	...
	(*Id)(nil),              // 2: quizzes.Id
	(*Quiz)(nil),            // 3: quizzes.Quiz
	(*QuizAnswer)(nil),      // 4: quizzes.QuizAnswer
}
var file_quizzes_quiz_service_proto_depIdxs = []int32{
	...
	3, // 3: quizzes.Quizzes.Update:output_type -> quizzes.Quiz
	4, // 4: quizzes.Quizzes.Answer:output_type -> quizzes.QuizAnswer
	3, // 5: quizzes.Quizzes.Get:output_type -> quizzes.Quiz
