...
var file_quizzes_quiz_service_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x70, 0x75, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x79, 0x0a, 0x07, 0x51,
	...
	0x6d, 0x73, 0x77, 0x65, 0x72, 0x12, 0x18, 0x2e, 0x71, 0x75, 0x69, 0x7a, 0x7a, 0x65, 0x73, 0x2e,
	...
	0x73, 0x77, 0x65, 0x72, 0x22, 0x00, 0x42, 0x26, 0x5a, 0x24, 0x6c, 0x6d, 0x73, 0x2d, 0x71, 0x75,
	0x69, 0x7a, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x70, 0x62, 0x2f, 0x71,
	0x75, 0x69, 0x7a, 0x7a, 0x65, 0x73, 0x3b, 0x71, 0x75, 0x69, 0x7a, 0x7a, 0x65, 0x73, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var file_quizzes_quiz_service_proto_goTypes = []interface{}{
	(*QuizUpdateInput)(nil), // 0: quizzes.QuizUpdateInput
	(*QuizAnswerInput)(nil), // 1: quizzes.QuizAnswerInput
	(*Quiz)(nil),            // 2: quizzes.Quiz
	(*QuizAnswer)(nil),      // 3: quizzes.QuizAnswer
}
var file_quizzes_quiz_service_proto_depIdxs = []int32{
	0, // 0: quizzes.Quizzes.Update:input_type -> quizzes.QuizUpdateInput
	1, // 1: quizzes.Quizzes.Amswer:input_type -> quizzes.QuizAnswerInput
	2, // 2: quizzes.Quizzes.Update:output_type -> quizzes.Quiz
	3, // 3: quizzes.Quizzes.Amswer:output_type -> quizzes.QuizAnswer
