...
var file_quizzes_quiz_service_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x92, 0x02, 0x0a, 0x07, 0x51,
	...
	0x73, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x42,
	0x14, 0x5a, 0x12, 0x70, 0x62, 0x2f, 0x71, 0x75, 0x69, 0x7a, 0x7a, 0x65, 0x73, 0x3b, 0x71, 0x75,
	0x69, 0x7a, 0x7a, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_quizzes_quiz_service_proto_goTypes = []any{
	...
	(*BoolMessage)(nil),        // 6: quizzes.BoolMessage
}
var file_quizzes_quiz_service_proto_depIdxs = []int32{
	...
	4, // 5: quizzes.Quizzes.Update:output_type -> quizzes.Quiz
	5, // 6: quizzes.Quizzes.Answer:output_type -> quizzes.QuizAnswer
	4, // 7: quizzes.Quizzes.Get:output_type -> quizzes.Quiz
	5, // 8: quizzes.Quizzes.GetResultQuiz:output_type -> quizzes.QuizAnswer
	6, // 9: quizzes.Quizzes.Delete:output_type -> quizzes.BoolMessage
